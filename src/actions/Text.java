...
// This contains drawString, which allows text to be drawn
public class Text {

 public static void drawString(String s, float x, float y, float scale, float width, float colorA, float colorB, float colorC) {
      float startX = x;
      scale = scale * 0.25f;
      GL11.glLineWidth(width);
      GL11.glBegin(GL11.GL_LINES);
      GL11.glEnable(GL11.GL_LINE_WIDTH);
      GL11.glColor3f(colorA, colorB, colorC);
      boolean space = false;
      ...
      for (char c : s.toLowerCase().toCharArray()) {
          ...
          case '.':
        	  ...
        	  GL11.glVertex2f(scale * startX, scale * y - 0.03f);
        	  GL11.glVertex2f(scale * startX + 0.3f, scale * y - 0.03f);
        	  GL11.glVertex2f(scale * startX + 0.3f, scale * y - 0.05f);
        	  break;
          
          case '-':
        	  
        	  GL11.glVertex2f(scale * startX, scale * y);
        	  GL11.glVertex2f(scale * startX + 0.05f, scale * y);
        	  break;
        	  
          case ':':
        	  
        	  GL11.glVertex2f(scale * startX, scale * y + 0.03f);
        	  GL11.glVertex2f(scale * startX, scale * y + 0.01f);  
        	  GL11.glVertex2f(scale * startX, scale * y - 0.05f);
        	  GL11.glVertex2f(scale * startX, scale * y - 0.03f);
